...
class ResNet18(nn.Module):
    ...
    def __init__(self):
        ...
        self.blk3 = ResBlk(128, 128, stride=1)
        self.blk4 = ResBlk(128, 256, stride=2)
        # [b, 256, h/4, w/4] => [b, 512, h/8, w/8]
        self.blk5 = ResBlk(256, 256, stride=1)
        self.blk6 = ResBlk(256, 512, stride=2)
        # [b, 512, h/8, w/8] => [b, 512, h/16, w/16]
        self.blk7 = ResBlk(512, 512, stride=1)
        self.blk8 = ResBlk(512, 512, stride=2)
